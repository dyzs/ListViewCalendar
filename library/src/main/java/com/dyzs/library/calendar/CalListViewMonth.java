 ...
 * @since Oct. 12, 2015
 */
public class CalListViewMonth implements Parcelable {
	 ...
	 * Parcelable Stuff.
	 */
	private CalListViewMonth(Parcel in) {
	 ...
	 */
	public CalListViewMonth(int year, int month, int day) {
		mYear = year;
		mMonth = month;
		mDay = day;
	 ...
	 */
	public static final Creator<CalListViewMonth> CREATOR = new Creator<CalListViewMonth>() {
		public CalListViewMonth createFromParcel(Parcel in) {
			return new CalListViewMonth(in);
		}

		public CalListViewMonth[] newArray(int size) {
			return new CalListViewMonth[size];
		}
	};
	/* 生成工作日历 */
